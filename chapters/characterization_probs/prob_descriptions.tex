...
% In general, add dimensions for everything so that we know how big these problems are, where the sources are located, and where the detectors are located. Right now, no one could reproduce any of this. 
% Also, state all the materials, including if there is a type of concrete used. 
