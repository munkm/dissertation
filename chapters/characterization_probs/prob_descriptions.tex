...
Sections \ref{sec:contributon} and \ref{sec:applicationprobs}, that ray
...
from algorithmic limitations (ray effects). These processes have some parameter
space that overlap, so we will continue with a brief discussion about how each
of these apply to anisotropic problems.

Flux anisotropy arising from strong differences in material properties
