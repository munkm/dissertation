...
\subsubsection*{Labyrinth Variants}

The labyrinth variants have isotropic point sources on the left hand side of the
...
air region of that variant problem. Both problems have strong
...
used to meausure the response on the right hand side of the problem in yellow.
...
CADIS-run of this problem, we seek to optimize the dose response of the
technician in the hallway. Because this problem is primarily air with concrete
