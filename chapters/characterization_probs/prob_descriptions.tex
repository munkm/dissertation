...
% Idk what "immersed in a pure thin material" means
...
% this doesnt seem to fall into the two materials category, but closer to the source category, so I moved it into the source
...
% I think I've made this clearer and a little better separated? I think this is sort of the distinction you mean? I'm not completely clear though. 
A second example is when material A has low absorption but high scattering potential. In
...
% What you had before wasn't really correct. 
...
% I don't understand the difference between what you're calling streaming paths
% and problems with high material hetergeneity. I think it is just two differen version
% of material hetergeneity causing streaming -- and in reality they're both low absoprtion...one just has more scattering and one doesn't. 
...
% In general, add dimensions for everything so that we know how big these problems are, where the sources are located, and where the detectors are located. 
...
% Skipping this subsubsection b/c I think you're deleting it.
\begin{figure}[h!]
  \centering
...
%Did I write those captions correctly? 
...
\begin{figure}[h!]
  ...
  \label{fig:prob4geom}
\end{figure}
% again, include actual locations of where these images are

The shielding material illustrated in Figure \ref{fig:prob4geom} simulates rebar in concrete. In this problem, a NaI detector is
used to measure the response on the right hand side of the problem in yellow.
% the beam problem is a real problem, just a different one :)
...
% this explanation seems wrong. Why are the images oriented differently? 
% AGain, more details about the geometry.
...
% they're not? It looks like they are...
 This problem 
...
The physics that of each characterization problem is summarized in Table \ref{tab:probphysics}.
...
% I don't think material heterogeneity and streaming paths are different, so you could remove that column to add source energy and write either the energy or watt-fission.
%  Instead of an x in monodir, you could write source type and include one of mono-dir or point?
...
% I am not sure that I understand this. How is the average outside the min and max? That doesn't make sense. 
...
\end{table}
% add more lines. This table is very very hard to read. I'd remove the analog time column to give yourself more room and just specify it in the text.
...
% put a line between each of these regions
...
both methods.
% I understand the anisotropy thing, is the other stuff double counted for some reason? That isn't clear.
...
%\end{figure}
% Do you show these later? I don't think it makes sense to show sample results. Just show results when you show them. 
...
% is this new information? If not, cut the paragraph or only keep what is new.

% I guess I should have been clearer about setting up the problems. (though perhaps it was hard to understand with just the outline
% I think the information you provided above about times, etc. is really good. 
% This stuff doesn't seem to fit. I think you'll have to explain the plots when you get to them. It feels weird to see examples of results that are them presented as results.
% I'd cut everything down to the line below unless there are key pieces of information that need to be distilled out for interpreting everything. 
% You can use the text when you explain the plots for the first time. 
...
% This stuff seems relevant again to have before the rest of the problems.
...
% the below paragraph again seems like it should just be in the results discussion.
...
% the paragraphs down to the line also seem like they don't fit here.
