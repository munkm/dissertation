...
% perhaps hammer a little more that we don't expect cadis omega to be good with isotropic scattering?

% In the thin material discussion, I think what's missing is how the weight windows actually work.
% the problem is the extreme splitting that happens. Can you discuss and possibly give an example?
To add to this complexity, problems with little scattering were also
...
% I disagree. It seems to me that for problems that have strong streaming and enough material
% interaction to avoid the over-splitting caused by air, CADIS-\Omega should be chosen.
% this is completely consistent with theory. 
However,
...
best results with a lower P$_N$ order and intermediate QR orders.% yay!
...
% ah, this is the explanation I was looking for. Would be great if you could move it up and repeat it here!
...
Further, with the strong dependence on angle, the $\Omega$-fluxes may
