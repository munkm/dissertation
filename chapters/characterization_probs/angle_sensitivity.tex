...
% please be careful throughout about specifying angular vs. scalar flux!
...
flux. 
% what? I am not sure that's true. Step characteristic as a spatial method does, but I'm pretty sure QR doesn't do that. 
...
% what you had written is incorrect. We're looking at the impact of ray effects.
...
In [specify which] subsection of the table, it is also notable that the oscillations between
...
deterministic calculation parameters.}
  \label{tab:quad_foms}
\end{table}
% Please fix the table. You're using QR quarature, not SN

The minimum relative error FOM behavior is
...
% S_N is level symmetric quadrature, not QR.
...
% FOM is basically the only metric that matters.
...
% are you actually measuring particle count, or are you measuring RE? RE is a function of nps and particle weight, so they may not be directly related.
The table
...
% do we have an explanation for this?  Seems like a lot of results are described but not explained. 
% if you don't have time to add it, it's ok. It just won't work for a paper later. 
...
% for future papers, let's focus way more on explaining the why and much less on explaining what is visible in the plots and tables. 
...
Let us return again to the high and low-energy regions, as explored
...
% I don't think you  need to do those things at this point. What you really really really really really really need to add,
% is a discussion about ray effects!!!
...
% again, an explanation would be helpful here.
...
% instead of adding these, I'd spend more time explaining the results that are already here as in, what do they mean? why do they happen? Not just reporting the plots. 
...
The data in this figure also show us that increasing P$_N$ order for
