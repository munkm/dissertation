...
\begin{table}[h!]
  \centering
  \input{./chapters/characterization_probs/figures/char/prob_4_iso/problem_4_tally_foms_compare}
  \caption[Figure of Merit comparison between methods for rebar-embedded
...
\begin{table}[h!]
  \centering
  \input{./chapters/characterization_probs/figures/char/prob_4_iso/problem_4_tally_times_compare}
...
anisotropy distributions occur closer to the forward source. As with Figure
...
algorithm. Figure \ref{fig:M3isostatsrebar} shows these trends for the problem
...
\ref{fig:M3isostatsrebar}. The x-values between each of these figures will be the
...
\begin{table}[h!]
  \centering
  \input{./chapters/characterization_probs/figures/char/therapy_iso/therapy_room_tally_foms_compare}
  \caption[Tally results comparison between methods for simplified medical
