...
\texit{contributon}, is defined. The contributon carries response in the problem
...
Much of the work in this realm has been done
...
% RNS: checking, did you define NTE as an acronym already?
...
\end{aligned}
\end{equation}
% RNS: Is the first item here Sigma_s and the second Sigma_a? It's not entirely clear right now.
