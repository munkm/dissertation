...
Monte Carlo.
% Maybe I want to make a new generic "Automated VR" section that comes before
% the local, global, and angle sections. I could introduce the MCNP WWgenerator,
% and earlier work like Tang and Hoffman's.....
