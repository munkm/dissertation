...
external fixed source. This equation tells us where particles are moving
...
into $\hat\Omega$. Thus, for a particular problem with a given $q_{e}$,
particles start at the location of $q_e$ and move throughout the system,
either downscattering in energy, being absorbed by the problem materials, or
inducing a response at the tally location.
